...
class WhaleConfig(Config):
    ...
    NUM_CLASSES = 1 + 2 # + 2 # Background + blue body/pec + humpback body/pec
...
class WhaleDataset(utils.Dataset):
    ...
    def load_whale(self, dataset_dir, subset):
        ...
        """
        # Add classes.
        #self.add_class("whale", 3, "Balaenoptera_musculus_body")
        #self.add_class("whale", 4, "Balaenoptera_musculus_pectoral")
        self.add_class("whale", 1, "megaptera_novaeangliae_body")
        self.add_class("whale", 2, "megaptera_novaeangliae_pectoral")
...
def train(model):
    ...
    #print("Training network in its entirety")
